...
namespace Common
{
    const float Matrix3::EPSILON = static_cast<float>(1e-06);
    const Matrix3 Matrix3::ZERO(0,0,0,0,0,0,0,0,0);
    const Matrix3 Matrix3::IDENTITY(1,0,0,0,1,0,0,0,1);
	const float Matrix3::msSvdEpsilon = static_cast<float>(1e-04);
    ...
    float Matrix3::MaxCubicRoot (float afCoeff[3])
    {
		...
		const float fEpsilon = static_cast<float>(1e-06);
